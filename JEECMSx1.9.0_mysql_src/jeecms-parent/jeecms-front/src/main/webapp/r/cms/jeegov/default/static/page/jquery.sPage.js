...
(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        creatHtml: function (i) {
            i == this.settings.page ? this.pageList.push('<button class="active sub-btn-page" data-page=' + i + '>' + i + '</button>')
                : this.pageList.push('<button data-page=' + i + ' class="sub-btn-page">' + i + '</button>');
        },
        viewHtml: function () {
            ...
            if (settings.showPN) {
                settings.page == 1 ? this.pageList.push('<button class="button-disabled" data-page="prev">' + settings.prevPage + '</button>')
                    : this.pageList.push('<button data-page="prev" class="btn-change-page">' + settings.prevPage + '</button>');
            }
            if (pageTatol <= 6) {
            ...
            if (settings.showPN) {
                settings.page == pageTatol ? this.pageList.push('<button class="button-disabled" data-page="next">' + settings.nextPage + '</button>')
                    : this.pageList.push('<button data-page="next" class="btn-change-page">' + settings.nextPage + '</button>');
            }
            ...
            if (settings.showSkip) {
                pageArr.push('<div class="spage-skip">到第&nbsp;<input type="text" value="' + settings.page + '"/>&nbsp;页&nbsp;&nbsp;<button data-page="go">确定</button></div>');
            }
