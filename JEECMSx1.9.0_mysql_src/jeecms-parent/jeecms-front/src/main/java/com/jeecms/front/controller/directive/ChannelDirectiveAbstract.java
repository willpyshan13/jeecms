...
public abstract class ChannelDirectiveAbstract implements TemplateDirectiveModel {
	 ...
	 * 自定义字段值
	 */
	private static final String ATTR_VAL = "attrVal";
	 ...
	 */
	protected String getAttrName(Map<String, TemplateModel> params) throws TemplateException {
		return DirectiveUtils.getString(ATTR_NAME, params);
	}
	 ...
	 * @throws TemplateException
	 */
	protected String getAttrVal(Map<String, TemplateModel> params) throws TemplateException {
		return DirectiveUtils.getString(ATTR_VAL, params);
	}
