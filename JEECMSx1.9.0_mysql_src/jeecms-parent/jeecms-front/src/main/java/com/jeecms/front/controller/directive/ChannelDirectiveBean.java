...
public class ChannelDirectiveBean extends ChannelDirectiveAbstract {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		String attrName = getAttrName(params);
		String attrVal = getAttrVal(params);
		Channel channel = null;
		if(id!=null||path!=null){
			/**id或者路径查询*/
			channel = channelService.get(id, siteId, path);
		}else{
			/**自定义字段和parentId查询*/
			channel = channelService.getByAttr(parentId,attrName,attrVal);
		}
