...
public class MessageInfo implements Serializable {
	...
	public static class MessageInfoBuilder {
		...
		public MessageInfo build() {
			...
			return new MessageInfo(targetType, orgId, memberGroupId, memberLevelId, receiveIds, messageCode, scene,
					title, textContent, phones, emails, data, sendType, siteId,dto);
		}
		...
		public MessageInfoBuilder(List<String> phones, List<String> emails, JSONObject data, Integer targetType, Integer orgId,
				...
				MessageSceneEnum scene, String title, String textContent, Short sendType, Integer siteId,MessageExpandDto dto) {
			super();
			this.phones = phones;
			this.emails = emails;
			this.data = data;
	...
	public MessageInfo(Integer targetType, Integer orgId, Integer memberGroupId, Integer memberLevelId,
			...
			List<String> phones, List<String> emails, JSONObject data, Short sendType, Integer siteId,MessageExpandDto messageExpandDto) {
		super();
		this.targetType = targetType;
		this.orgId = orgId;
		this.memberGroupId = memberGroupId;
