...
public class MqSendMessageServiceImpl implements MqSendMessageService {
	...
	public void sendMemberMsg(Integer targetType, Integer orgId, Integer memberGroupId, Integer memberLevelId,
            ...
            MessageExpandDto messageExpandDto) throws GlobalException {
	    if(siteId == null) {
            siteId = SystemContextUtils.getSiteId(RequestUtils.getHttpServletRequest());
        }
		MessageInfoBuilder builder = new MessageInfoBuilder(toPhones, toEmails, data, targetType, orgId, memberGroupId, memberLevelId, receiveIds, messageCode, scene, title, textContent, sendType, siteId,messageExpandDto);
