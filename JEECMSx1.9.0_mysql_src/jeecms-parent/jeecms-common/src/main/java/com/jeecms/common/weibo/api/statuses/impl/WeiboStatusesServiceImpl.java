...
import com.jeecms.common.weibo.bean.response.statuses.Statuses;
...
public class WeiboStatusesServiceImpl implements WeiboStatusesService {
	...
	/** 根据微博ID获取单条微博内容 **/
	public static final String GET_STATUSES_URL = Constants.BASE_URL.concat("statuses/show.json");
	...
	*@throws GlobalException 异常
	...
	@Override
	public Statuses getByWeiboId(Long weiboId, String token) {
		Map<String, String> params = new HashMap<String, String>(16);
		params.put(ACCESS_TOKEN, token);
		params.put(ID, weiboId.toString());
		Statuses response = HttpUtil.getJsonBean(STATUSES_URL, params,
				Statuses.class);
