...
public class ResponseInfo {
	 ...
	 * @param data
	 *            响应数据。
	 * @param msgObjs  响应国际化消息中占位符值对象数组
	 */
	public ResponseInfo(String code, String message, HttpServletRequest request, String redirectUrl, Object data,Object[]msgObjs) {
		this.code = Integer.parseInt(code);
		this.message = MessageResolver.getMessage(code,msgObjs, message);
		this.requestUrl = request.getRequestURI();
		this.redirectUrl = redirectUrl;
		this.data = data;
	}
