...
public enum SettingErrorCodeEnum implements ExceptionInfo {
     ...
     * 微信设置不能为空
     **/
    WECHAT_NOT_NULL("13189", "The WeChat setting cannot be empty!"),
    /**
     * 支付宝设置不能为空
     **/
    ALIPAY_NOT_NULL("13190", "The Alipay setting cannot be empty!"),
    /**
     * 打赏金额范围不能为空
     **/
    AMOUNT_NOT_NULL("13191", "The reward amount range cannot be empty!"),
    /**
     * 平台抽成配置不能为空
     **/
    PLATFORM_NOT_NULL("13192", "Platform allocation cannot be empty!"),
    /**
     * 提现配置不能为空
     **/
    WITHDRAWAL_NOT_NULL("13193", "The withdrawal configuration cannot be empty!"),
    /**
     * 未设置微信/支付宝转账账号，无法提现
     **/
    ACCOUNT_NOT_SET("13194", "WeChat/Alipay transfer account is not set and cannot be withdrawn!"),
    /**
     * 最大显示头像数量不能为空
     */
    MAXIMUM_NUMBER_OF_AVATARS_DISPLAYED_NOT_NULL("13195", "Maximum number of avatars displayed not null!"),
    ;
