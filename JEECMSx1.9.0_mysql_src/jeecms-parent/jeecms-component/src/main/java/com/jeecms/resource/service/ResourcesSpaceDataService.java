...
public interface ResourcesSpaceDataService extends IBaseService<ResourcesSpaceData, Integer> {
	 ...
	 * @throws GlobalException 异常
	 */
	void share(ResourcesSpaceShareDto dto) throws GlobalException;
	 ...
	 * @return: getFile
	 */
	File getFileWithFilename(ResourcesSpaceData data, String filename);
	 ...
	 * @return File
	 */
	File getFile(ResourcesSpaceData data, String path);
