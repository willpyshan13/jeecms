...
public class QContent extends EntityPathBase<Content> {
    ...
    public final DateTimePath<java.time.LocalDateTime> lastPayTime = createDateTime("lastPayTime", java.time.LocalDateTime.class);
    ...
    public final NumberPath<Long> paidAmountInitial = createNumber("paidAmountInitial", Long.class);

    public final NumberPath<Long> rewardAmountInitial = createNumber("rewardAmountInitial", Long.class);

    public final NumberPath<Long> totalAmountInitial = createNumber("totalAmountInitial", Long.class);

    public final NumberPath<Integer> paidCount = createNumber("paidCount", Integer.class);

    public final NumberPath<Integer> payPraise = createNumber("payPraise", Integer.class);

    public final NumberPath<Long> payPrice = createNumber("payPrice", Long.class);

    public final NumberPath<Integer> payRead = createNumber("payRead", Integer.class);
    ...
    public final NumberPath<Integer> trialReading = createNumber("trialReading", Integer.class);
