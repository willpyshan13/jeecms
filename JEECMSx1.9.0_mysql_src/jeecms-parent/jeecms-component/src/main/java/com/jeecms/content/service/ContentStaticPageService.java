...
public interface ContentStaticPageService {
     ...
     */
    void contentRelated(Content content, boolean ignoreException, HttpServletRequest request, HttpServletResponse response)
            throws GlobalException;
     ...
     */
    void deleteContentRelated(Content content, boolean ignoreException, HttpServletRequest request, HttpServletResponse response)
            throws GlobalException;
     ...
     *                 GlobalException
     */
    void deleteContent(Integer siteId, List<Integer> channelIds, HttpServletRequest request,
     ...
     *                 GlobalException
     */
    void deleteChannel(Integer siteId, List<Integer> channelIds, boolean ignoreException,
     ...
     * @throws GlobalException  全局异常
     */
    void deleteIndex(CmsSite site) throws GlobalException;
