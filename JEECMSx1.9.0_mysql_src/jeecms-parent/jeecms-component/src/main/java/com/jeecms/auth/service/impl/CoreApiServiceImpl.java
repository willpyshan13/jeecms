...
public class CoreApiServiceImpl extends BaseServiceImpl<CoreApi, CoreApiDao, Integer> implements CoreApiService {
        ...
        @Override
        public Page<CoreApi> getPage( String apiUrl,String apiName,Pageable pageable, boolean cacheable) {
                Map<String, String[]> params = new HashMap<>();
                params.put(SearchFilter.Operator.LIKE.toString()+"_"+"apiName",new String[]{apiName});
                params.put(SearchFilter.Operator.LIKE.toString()+"_"+"apiUrl",new String[]{apiUrl});
                return super.getPage(params, pageable, cacheable);
        }
}
