...
public class CmsOrg extends com.jeecms.common.base.domain.AbstractTreeDomain<CmsOrg, Integer> implements Serializable {
        ...
        Paginable paginable = new PaginableRequest(0, 1000000);
...
//                }
                CmsDataPermService dataPermService = ApplicationContextProvider.getBean(CmsDataPermService.class);
                dataPerms.addAll(dataPermService.findList(getId(), null, null, siteId, type, operator, dataId, paginable));
                return dataPerms;
        }
        ...
        public boolean getHasAssignDataPermsByType(Short type) {
                ...
                CmsDataPermService dataPermService = ApplicationContextProvider.getBean(CmsDataPermService.class);
                long dataPermCount = dataPermService.getCount(getId(), null, null, null, type, null, null);
                if (dataPermCount > 0) {
                        return true;
                }
                return false;
