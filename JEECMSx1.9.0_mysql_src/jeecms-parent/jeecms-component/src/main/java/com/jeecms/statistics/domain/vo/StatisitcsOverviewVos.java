...
public class StatisitcsOverviewVos {
	...
	/** 最高*/
	private StatisitcsOverviewVo sum;
	...
	public StatisitcsOverviewVos(StatisitcsOverviewVo now, StatisitcsOverviewVo yesterday,
			StatisitcsOverviewVo highest, StatisitcsOverviewVo sum) {
		super();
		this.now = now;
	...
	public StatisitcsOverviewVo getSum() {
		return sum;
	}

	public void setSum(StatisitcsOverviewVo sum) {
		this.sum = sum;
	}
}
