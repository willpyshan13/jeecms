...
public interface ContentFrontService {
	...
	Page<Content> getPage(Integer channelOption,Integer[] channelIds, Integer[] tagIds, String[] channelPaths, Integer siteId,
						  ...
						  Integer[] modelId, Integer orderBy, Pageable pageable, CmsSite site, List<Integer> contentSecretIds);
	 ...
	 * @return 内容集合
	 */
	List<Content> getList(Integer[] relationIds, Integer orderBy, Integer count, List<Integer> contentSecretIds);
	 ...
	 * @return 内容列表
	 */
	List<Content> findAllById(List<Integer> ids, Integer orderBy, List<Integer> contentSecretIds);
	...
	Content getSide(Integer id, Integer siteId, Integer channelId,
					Boolean next, List<Integer> contentSecretIds);
	 ...
	 * @return 详细投稿信息
	 */
	ContentContributeVo splicContributeVo(Integer contentId,Integer userId);
	...
	* @param pageable 分页对象
	 */
	Page<ContentFrontVo> getMobilePage(Integer siteId, Integer userId, Integer status, List<Integer> contentSecretIds, Pageable pageable);
