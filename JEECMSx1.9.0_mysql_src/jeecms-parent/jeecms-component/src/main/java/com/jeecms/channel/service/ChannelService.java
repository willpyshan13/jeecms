...
public interface ChannelService extends IBaseService<Channel, Integer> {
     ...
     * @return
     */
    long countByPathBeforeAndRecycleAndHasDeleted(Integer siteId, String path, Boolean recycle, Boolean hasDeleted);
    ...
    /**
     * 根据字段名和字段值来查询某个栏目
     * @param parentId 父栏目（含所有某个栏目的下级节点）
     * @param attrName 字段名
     * @param attrVal 字段值
     * @return
     */
    Channel getByAttr(Integer parentId, String attrName, String attrVal);
     ...
     * @return
     */
    List<Integer> getChildChannelList(Integer siteId,boolean containNotDisplay);
     ...
     * @Title: findTopList
     */
    List<Channel> findTopList(Integer siteId);
}
