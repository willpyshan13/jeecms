...
public class SysMessageDto {
	...
	private MessageExpandDto messageExpandDto;

	public SysMessageDto() {
	}

	/** 接受对象类型：1,2,3*/
	public SysMessageDto(String title, String content, Integer recTargetType,MessageExpandDto messageExpandDto) {
		super();
		this.title = title;
		this.content = content;
		this.recTargetType = recTargetType;
		this.messageExpandDto = messageExpandDto;
	}

	/** 接受对象类型：4,5*/
	public SysMessageDto(String title, String content, Integer recTargetType, List<Integer> userId,MessageExpandDto messageExpandDto) {
		super();
		this.title = title;
		this.content = content;
		this.recTargetType = recTargetType;
	...
	public SysMessageDto(String title, String content, Integer recTargetType, Integer memeberLevelId,
			Integer memeberGroupId, List<Integer> memeberId, List<Integer> userId,MessageExpandDto messageExpandDto) {
		super();
		this.title = title;
		this.content = content;
		this.recTargetType = recTargetType;
    ...
    public MessageExpandDto getMessageExpandDto() {
        return messageExpandDto;
    }

    public void setMessageExpandDto(MessageExpandDto messageExpandDto) {
        this.messageExpandDto = messageExpandDto;
    }
