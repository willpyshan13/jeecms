...
public class CmsSiteConfig implements Serializable {
	...
	/** 邮箱密码 **/
	public static final String EMAIL_PDW = "emailPassword";
	/** 是否使用SSL协议(1使用 0不使用) **/
	public static final String SSL_USE = "sslUse";

	/******************** 站点访问配置 **********************************/
	/** 登录后才能访问站点 **/
	public static final String LOGIN_SUCCESS_VISIT_SITE = "loginSuccessVisitSite";
	/** 是否采用相对路径 */
	...
	* @return
	...
	public String getEmailPassword() {
		String str = this.getAttr().get(EMAIL_PDW);
		return str;
	}

	public void setEmailPassword(String str) {
		this.getAttr().put(EMAIL_PDW, str);
	}
