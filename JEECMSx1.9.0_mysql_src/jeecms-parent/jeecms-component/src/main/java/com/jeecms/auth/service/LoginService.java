...
public interface LoginService {
        ...
        void loginAfter(LoginDetail loginDetail, String ip, boolean loginSuccess, String uniquePushId,
                        AuthConstant.LoginFailProcessMode processMode) throws GlobalException;
}
