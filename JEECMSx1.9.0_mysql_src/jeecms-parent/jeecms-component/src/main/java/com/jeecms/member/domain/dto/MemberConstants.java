...
public class MemberConstants {
	...
	/** 找回密码 */
	public static final String CODE_SECOND_LEVEL_IDENTITY_RETRIEVE_PDW = "retrieve_";

	// 三级键名
	/** 第三方登录state */
	public static final String CODE_THREE_LEVResponseUtilsEL_IDENTITY_STATE = "login_state";
