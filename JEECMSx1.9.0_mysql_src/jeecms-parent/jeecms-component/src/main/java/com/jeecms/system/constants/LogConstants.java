...
public class LogConstants {
	...
	public static final Integer LOG_OPERATE_LOGIN = 9;
	public static final Integer LOG_OPERATE_LOGOUT = 10;
	...
	public static String operate(Integer operate) {
		if (LOG_OPERATE_QUERY.equals(operate)) {
			...
			return "下载";
		} else if (LOG_OPERATE_LOGIN.equals(operate)) {
			return "登录";
		} else if (LOG_OPERATE_LOGOUT.equals(operate)) {
			return "退出";
		}
		return "系统异常";
	}
