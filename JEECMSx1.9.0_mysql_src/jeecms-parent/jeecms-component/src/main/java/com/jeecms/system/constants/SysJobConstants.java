...
public class SysJobConstants {
     ...
     * 分组名-定时信件评分
     */
    public static final String GROUP_NAME_LETTER_SCORE = "CmsLetterScoreJobGroup";
    /**
     * 定时任务名字前缀-定时发布表单
     */
     ...
     * 定时任务名字前缀-定时信件评分
     */
    public static final String NAME_PREFIX_LETTER_SCORE = "CmsLetterScoreJob_";
     ...
     * 类路径-定时评分信件
     */
    public static final String CLASS_PATH_LETTER_SCORE = "com.jeecms.system.job.LetterScoreJob";
     ...
     * 删除日志数据
     */
    public static final String DELETE_LOG_DATA = "com.jeecms.system.job.DeleteLogDataJob";

    /**
     * 分组---删除日志
     */
    public static final String GROUP_NAME_DELETE_LOG_DATA = "deleteLogDataJob";
