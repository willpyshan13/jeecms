...
public class QCoreUser extends EntityPathBase<CoreUser> {
    ...
    public final ListPath<CoreMenu, QCoreMenu> menus = this.<CoreMenu, QCoreMenu>createList("menus", CoreMenu.class, QCoreMenu.class, PathInits.DIRECT2);
    ...
    public final ListPath<CoreRole, QCoreRole> roles = this.<CoreRole, QCoreRole>createList("roles", CoreRole.class, QCoreRole.class, PathInits.DIRECT2);
    ...
    public final QUserIncome userIncome;
    ...
    public QCoreUser(Class<? extends CoreUser> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userIncome = inits.isInitialized("userIncome") ? new QUserIncome(forProperty("userIncome"), inits.get("userIncome")) : null;
