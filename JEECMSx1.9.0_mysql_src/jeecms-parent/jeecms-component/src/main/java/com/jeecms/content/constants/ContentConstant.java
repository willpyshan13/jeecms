...
public class ContentConstant {
	...
	/**站点内不允许重复*/
	public static final Integer CONTENT_REPEAT_SITE=2;
	/**同一栏目内不允许重复*/
	public static final Integer CONTENT_REPEAT_CHANNEL=3;
	...
	/**
	 * 收益统计的排序 1、售价正序 2、售价倒叙 3、总收益正序 4、总收益倒叙 5、打赏正序 6、打赏倒叙 7、付费正序 8、付费倒叙
	 */
	...
	public static final int SORT_TYPE_7=7;
	public static final int SORT_TYPE_8=8;
