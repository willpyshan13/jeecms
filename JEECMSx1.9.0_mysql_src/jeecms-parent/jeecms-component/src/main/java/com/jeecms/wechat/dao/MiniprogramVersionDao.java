...
public interface MiniprogramVersionDao extends IBaseDao<MiniprogramVersion, Integer>,MiniprogramVersionDaoExt{
	 ...
	 * @return: String
	 */
	@Query("select bean.codeVersion from MiniprogramVersion bean where 1 = 1 and bean.versionType=3 and bean.hasDeleted = false and bean.appId=?1")
	 ...
	 */
	@Query("select bean from MiniprogramVersion bean where 1 = 1 and bean.versionType=?2 and bean.hasDeleted = false and bean.appId=?1")
	 ...
	 * @return: MiniprogramVersion
	 */
	@Query("select bean from MiniprogramVersion bean where 1 = 1 and bean.versionType=?2 and bean.hasDeleted = false and bean.appId=?1 and bean.status=?3")
