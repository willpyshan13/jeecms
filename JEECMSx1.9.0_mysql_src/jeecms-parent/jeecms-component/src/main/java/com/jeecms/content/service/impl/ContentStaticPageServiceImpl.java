...
public class ContentStaticPageServiceImpl extends AbstractContentListener implements ContentStaticPageService {
     ...
     * 内容静态化生成
     *
     * @param channel         要静态化的栏目
     * @param contentCount    要静态化的栏目下内容总数
     * @param containChild    是否包含子栏目
     * @param ignoreException 是否忽略异常
     * @param processResult   进度结果对象
     ...
     * 内容静态化生成和删除通用方法
     *
     * @param delete          true 是删除 false是生成
     * @param siteId          站点ID
     ...
     *
     * @param site          站点
     * @param config        GlobalConfigDTO 配置对象
     * @param data          前台模板所需 Map参数
     * @param c             内容对象
     * @param tplPath       pc模板
     * @param mobileTplPath 手机模板
     * @throws GlobalException GlobalException
     ...
     * @param c               内容对象
     * @param pc              是否pc静态页
     * @param ignoreException 是否关联自动触发 true是关联操作 false是手动触发
     * @param tplPath         模板路径
     * @param pageNo          内容分页
     * @throws GlobalException GlobalException
     * @Title: createContentPage
    ...
    private void createContentPage(CmsSite site, GlobalConfigDTO config, Map<String, Object> data, Content c,
        ...
        //判断是否需要截取字符串
        if (c.getRealPayRead() && c.getTrialReading() != null) {
            txt = SubStringUtil.interceptTxt(txt, c.getTrialReading());
        }
     ...
     *
     * @param channel         栏目
     * @param totalPage       栏目静态页数量
     * @param containChild    是否包含子栏目
     * @param ignoreException 是否忽略异常
     * @param processResult   进度对象
     * @param request         HttpServletRequest
     * @param response        HttpServletResponse
