...
public class GlobalConfigAttr implements Serializable {
     ...
     * 管理端logo图
     */
    public static final String SYS_IMG_URL = "sysImgUrl";
    /**
     * 微信公众号图片ID
     */
     ...
     * 加密方式更改后的初始用户密码
     **/
    public static final String DIGEST_CHANGE_USER_INIT_PDW = "initPasswd";
    ...
    /** 是否开启富文本参数Base64编码*/
    public static final String OPEN_PARAM_BASE64 = "openParamBase64";
    ...
    public String getInitPasswd() {
        String str = getAttr().get(DIGEST_CHANGE_USER_INIT_PDW);
        return str;
    }

    public void setInitPasswd(String initPasswd) {
        getAttr().put(DIGEST_CHANGE_USER_INIT_PDW, initPasswd);
    }
    ...
    public boolean getAutoLogoutOpen(){
        String str = getAutoLogout();
        if (StringUtils.isNoneBlank(str)) {
     ...
     * 是否开启富文本参数Base64编码
     */
    public boolean getOpenParamBase64() {
        String str = getAttr().get(OPEN_PARAM_BASE64);
        if (StringUtils.isNotBlank(str)) {
            return (TRUE_STRING).equals(str);
        }
        return false;
    ...
    public void setOpenParamBase64(String openParamBase64) {
        getAttr().put(OPEN_PARAM_BASE64, openParamBase64);
    }
