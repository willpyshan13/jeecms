...
public class ResourcesSpaceDataDaoImpl extends BaseDao<ResourcesSpaceData> implements ResourcesSpaceDataDaoExt {
    ...
    @Override
    public long countByAlias(String aliasPrefix, Integer userId, Integer storeResourcesSpaceId){
        JPAQuery<ResourcesSpaceData> jpaQuery = new JPAQuery<>(em);
        QResourcesSpaceData qSpaceData = QResourcesSpaceData.resourcesSpaceData;
        BooleanBuilder builder = new BooleanBuilder();
        if (aliasPrefix != null) {
            builder.and(qSpaceData.alias.startsWith(aliasPrefix));
        }
        if (userId != null) {
            builder.and(qSpaceData.userId.eq(userId));
        }
        ...
        return jpaQuery.from(qSpaceData).where(builder).fetchCount();
    }
