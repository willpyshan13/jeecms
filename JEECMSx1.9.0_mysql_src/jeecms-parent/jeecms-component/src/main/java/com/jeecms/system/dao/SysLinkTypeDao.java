...
public interface SysLinkTypeDao extends IBaseDao<SysLinkType, Integer>, SysLinkTypeDaoExt {
         ...
         * @return 友情链接列表
         */
        int countBySiteIdAndHasDeleted(Integer siteId, Boolean hasDeleted);
         ...
         * @return 友情链接类别对象
         */
        @Query("select bean.id from SysLinkType bean where bean.hasDeleted = false and bean.typeName = ?1 "
                + "and bean.siteId = ?2")
        Integer findByNameAndId(String typeName, Integer siteId);
}
