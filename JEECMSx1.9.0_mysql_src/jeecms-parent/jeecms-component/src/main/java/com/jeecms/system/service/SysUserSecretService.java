...
public interface SysUserSecretService extends IBaseService<SysUserSecret, Integer> {
	 ...
	 */
	void save(UserSecretDto userSecretDto, List<SysSecret> sysSecrets) throws GlobalException;
	 ...
	 * @throws GlobalException 异常
	 */
	void update(UserSecretDto userSecretDto, List<SysSecret> sysSecrets) throws GlobalException;
