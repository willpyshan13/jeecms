...
public interface ContentFrontDaoExt {
	...
	Page<Content> getPage(Integer channelOption,Integer[] channelIds, Integer[] tagIds, String[] channelPaths, Integer siteId,
						  ...
						  Integer[] modelId, Integer orderBy, List<Integer> contentSecretIds, Pageable pageable);
	...
	List<Content> getList(Integer channelOption,Integer[] channelIds, Integer[] tagIds, String[] channelPaths,
						  ...
						  Integer[] modelId, Integer orderBy, Integer count, List<Integer> contentSecretIds);
	 ...
	 * @return List
	 */
	List<Content> findByIds(List<Integer> ids, Integer orderBy, List<Integer> contentSecretIds);
	...
	Content getSide(Integer id, Integer siteId, Integer channelId,
					Boolean next, List<Integer> contentSecretIds, boolean cacheable);

    ContentContributeVo findContributoVo(Integer id, List<Integer> contentSecretIds);
}
