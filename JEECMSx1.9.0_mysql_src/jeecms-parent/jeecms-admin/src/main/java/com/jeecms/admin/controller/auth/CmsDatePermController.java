...
public class CmsDatePermController extends BaseAdminController<CmsDataPerm, Integer> {
	...
	@SerializeField(clazz = CmsSite.class, includes = { "id", "name" })
	public ResponseInfo getSites(Integer orgId, Integer roleId, Integer userId, Short dataType) {
		Set<CmsSite> sites = dataPermPlusService.getSites(orgId, roleId, userId, dataType);
