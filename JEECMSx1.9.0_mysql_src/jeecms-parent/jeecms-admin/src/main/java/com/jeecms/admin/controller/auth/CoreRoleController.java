...
public class CoreRoleController extends BaseAdminController<CoreRole, Integer> {
	...
	public ResponseInfo page(@RequestParam("orgid") Integer orgid, @RequestParam("roleName") String roleName,
		...
		Page<CoreRoleVo> coreRoleVos = coreRoleService.pageRoleForJson(ids, roleName, pageable);
		return new ResponseInfo(coreRoleVos);
	}
	...
	public ResponseInfo list(HttpServletRequest request, Integer orgId, String roleName) {
		...
		List<CoreRoleVo> roleVos = coreRoleService.listRoleVo(ids, roleName);
		return new ResponseInfo(roleVos);
	}
	...
	@PutMapping
    @OperatingIntercept
	public ResponseInfo update(HttpServletRequest request, @RequestBody @Valid CoreRole coreRole, BindingResult result)
			throws GlobalException {
		super.validateBindingResult(result);
	...
	public ResponseInfo userList(@NotNull Integer id, Pageable pageable, HttpServletRequest request) {
		...
		return new ResponseInfo(coreUserService.pageUser(null, null, roleids, null, true,
